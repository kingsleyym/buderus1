...
exports.unsubscribeNewsletter = exports.confirmNewsletter = exports.subscribeNewsletter = void 0;
...
exports.unsubscribeNewsletter = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        await logAnalyticsEvent('newsletter_unsubscribed', {
            subscriptionId: subscriberData === null || subscriberData === void 0 ? void 0 : subscriberData.subscriptionId,
            email_domain: (_a = subscriberData === null || subscriberData === void 0 ? void 0 : subscriberData.email) === null || _a === void 0 ? void 0 : _a.split('@')[1],
            was_confirmed: subscriberData === null || subscriberData === void 0 ? void 0 : subscriberData.confirmed
        });
        console.log('Newsletter Abmeldung erfolgreich für:', subscriberData === null || subscriberData === void 0 ? void 0 : subscriberData.email);
        return {
            success: true,
...
//# sourceMappingURL=newsletter-functions.js.map