...
exports.initializeDefaultTemplates = exports.renderTemplate = exports.getTemplates = exports.createTemplate = exports.BUDERUS_SIGNATURE_TEMPLATE = exports.BUDERUS_WELCOME_TEXT = exports.BUDERUS_WELCOME_TEMPLATE = exports.BUDERUS_CONFIRMATION_TEXT = exports.BUDERUS_CONFIRMATION_TEMPLATE = void 0;
...
exports.BUDERUS_CONFIRMATION_TEMPLATE = `
<!DOCTYPE html>
<html lang="de">
<head>
    <meta charset="UTF-8">
...
`;
exports.BUDERUS_CONFIRMATION_TEXT = `
{{salutation}},
...
exports.BUDERUS_WELCOME_TEMPLATE = `
<!DOCTYPE html>
<html lang="de">
<head>
    <meta charset="UTF-8">
    ...
    try {
        ...
        const templates = {
            'newsletter-confirmation': {
                html: exports.BUDERUS_CONFIRMATION_TEMPLATE,
                text: exports.BUDERUS_CONFIRMATION_TEXT
            },
            'newsletter-welcome': {
                html: exports.BUDERUS_WELCOME_TEMPLATE,
                text: exports.BUDERUS_WELCOME_TEXT
            },
            'newsletter-base': {
                html: exports.BUDERUS_SIGNATURE_TEMPLATE
            }
        };
        ...
        if (templateDoc.exists) {
            ...
            return {
                html: (data === null || data === void 0 ? void 0 : data.html) || '',
...
exports.BUDERUS_SIGNATURE_TEMPLATE = `
<!DOCTYPE html>
<html lang="de">
<head>
    <meta charset="UTF-8">
...
exports.createTemplate = functions.https.onCall(async (data, context) => {
    try {
        const uid = await (0, auth_1.isAuthenticated)(context);
        await (0, auth_1.isAdmin)(uid);
        const { name, description, type = 'newsletter', htmlContent, textContent, variables = [], isPublic = false } = data;
        if (!name || !htmlContent) {
        ...
        return {
            success: true,
            data: Object.assign({ id: templateId }, template),
...
exports.getTemplates = functions.https.onCall(async (data, context) => {
    try {
        ...
        snapshot.forEach(doc => {
            var _a, _b;
            const data = doc.data();
            templates.push(Object.assign(Object.assign({}, data), { createdAt: (_a = data.createdAt) === null || _a === void 0 ? void 0 : _a.toDate(), updatedAt: (_b = data.updatedAt) === null || _b === void 0 ? void 0 : _b.toDate() }));
        });
        return {
            success: true,
            data: templates,
 ...
 */
exports.renderTemplate = functions.https.onCall(async (data, context) => {
    try {
        await (0, auth_1.isAuthenticated)(context);
...
exports.initializeDefaultTemplates = functions.https.onCall(async (data, context) => {
    try {
        ...
        const templates = [
            {
                ...
                type: 'signature',
                htmlContent: exports.BUDERUS_SIGNATURE_TEMPLATE,
                variables: [
        ...
        for (const template of templates) {
            const templateId = db.collection('email_templates').doc().id;
            const now = admin.firestore.FieldValue.serverTimestamp();
            await db.collection('email_templates').doc(templateId).set(Object.assign(Object.assign({ id: templateId }, template), { createdAt: now, updatedAt: now, createdBy: uid }));
